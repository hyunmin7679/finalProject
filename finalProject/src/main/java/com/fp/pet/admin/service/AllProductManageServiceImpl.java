...
import com.fp.pet.admin.mapper.AllProductManageMapper;
import com.fp.pet.state.OrderState;

@Service
public class AllProductManageServiceImpl implements AllProductManageService {

	@Autowired
	private AllProductManageMapper mapper;
