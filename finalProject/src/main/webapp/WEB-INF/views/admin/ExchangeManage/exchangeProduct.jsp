...
<div class="content-wrapper">
	...
	<div class="container-xxl flex-grow-1 container-p-y">
		...
		<h4 class="py-3 mb-4">
			<span class="text-muted fw-light">주문관리 /</span> 교환관리
		</h4>
...
<script type="text/javascript">
	...
	$('body').on('click', '.orderDetailStatus-update', function(){
		...
		let detailNum3 = $(this).attr("data-detailNum3");
		let detailNum4 = $(this).attr("data-detailNum4");
		...
		f.detailNum3.value = detailNum3;
		f.detailNum4.value = detailNum4;
		f.productNum.value = productNum;
		
		let query = "changeNum="+changeNum;
		let url = '${pageContext.request.contextPath}/admin/ExchangeManage/returnFile'
		...
		if(PchangeState == 8 || PchangeState == 9){
			   $SELECT.hide();
			   $('form[name=detailStateForm] input[name=adminMemo]').hide();	
	...
	$(".btnDetailStateUpdateOk").click(function(){
		...
		let url = '${pageContext.request.contextPath}/admin/ExchangeManage/returnState';
