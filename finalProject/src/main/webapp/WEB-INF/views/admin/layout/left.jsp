...
<aside id="layout-menu"
	...
	<ul class="menu-inner py-1">
		...
		<li class="menu-item ${left=='AccountSettings'? 'active open':''}">
		<a href="javascript:void(0);"
			...
			<ul class="menu-sub">
				<li class="menu-item ${sub=='Account'?'active':''}">
				
				<a href="${pageContext.request.contextPath}/admin/inquiryManage/list" class="menu-link ">
						Account
				</a></li>
				<li class="menu-item ${sub=='Notifications'?'active':''}"><a
					href="${pageContext.request.contextPath}/admin/inquiryManage/list2" class="menu-link">
		...
		<li class="menu-item"><a href="javascript:void(0);"
			...
			<ul class="menu-sub">
				...
				<li class="menu-item"><a href="auth-forgot-password-basic.html"
					class="menu-link" target="_blank">
		...
		<li class="menu-item"><a href="cards-basic.html"
			class="menu-link"> <i class="menu-icon tf-icons bx bx-collection"></i>
