      ...
      <table class="table table-bordered" style="width: 1330px;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td colspan="4" >
            	<span><input type="radio" name="chk_info" value="HTML"/>전체</span>
            	<span><input type="radio" name="chk_info" value="HTML"/>상품준비중</span>
            	<span><input type="radio" name="chk_info" value="HTML"/>배송준비중</span>
            	<span><input type="radio" name="chk_info" value="HTML"/>배송보류</span>
            	<span><input type="radio" name="chk_info" value="HTML"/>배송대기</span>
            	<span><input type="radio" name="chk_info" value="HTML"/>배송중</span>
            	<span><input type="radio" name="chk_info" value="HTML"/>배송완료</span>
            </td>
          </tr>
