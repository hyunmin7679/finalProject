...
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">주문관리/</span> 교환상품조회
</h4>
<div class="row">
    ...
    <div class="nav-align-top mb-4" style="width: 1360px;">
      ...
      <ul class="nav nav-pills mb-3 nav-fill" role="tablist" style="width: 500px;">
        <li class="nav-item" role="presentation">
          <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-justified-home" aria-controls="navs-pills-justified-home" aria-selected="false" tabindex="-1"><i class="tf-icons bx bx-home me-1"></i> 교환신청된상품 <span class="badge rounded-pill badge-center h-px-20 w-px-20 bg-danger ms-1">3</span></button>
        </li>
        <li class="nav-item" role="presentation">
          <button type="button" class="nav-link " role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-justified-profile" aria-controls="navs-pills-justified-profile" aria-selected="true"><i class="tf-icons bx bx-user me-1"></i> 교환완료</button>
        </li>
        <!-- 
        <li class="nav-item" role="presentation">
									...
									<thead class="border-top">
										<tr>
											...
											<th class="w-20 sorting" tabindex="0"
												...
												aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
												style="width: 100px;"
												aria-label="progress: activate to sort column ascending">교환처리</th>
										</tr>
									</thead>
									<tbody>
										<tr class="odd">
									...
									<thead class="border-top">
										<tr>
											...
											<th class="w-20 sorting" tabindex="0"
												...
												aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
												style="width: 200px;"
												aria-label="progress: activate to sort column ascending">취소처리</th>
										</tr>
									</thead>
									<tbody>
										<tr class="odd">
											...
											<td><div class="text-body">카카오페이</div></td>
											<td><div class="text-body">취소신청[구매자]</div></td>
											<td><div class="text-body">취소완료</div></td>
												...
												<div class="row justify-content-end delivery-update-area">
													<div class="col-auto">
														<button type="button"
															...
															data-ordernum="202312091000000003" data-orderstate="2">교환접수완료</button>
													</div>
												</div>
											</td>
										</tr>
