					...
					<ul class="nav nav-pills mb-3 nav-fill" role="tablist"
						...
						<li class="nav-item" role="presentation">
							<button type="button" class="nav-link active" role="tab"
								...
								tabindex="-1">
								<i class="tf-icons bx bx-home me-1"></i> 취소신청된상품 <span
						...
						<li class="nav-item" role="presentation">
							<button type="button" class="nav-link " role="tab"
								...
								aria-selected="true">
								<i class="tf-icons bx bx-user me-1"></i> 취소완료
							</button>
						</li>
						<!-- 
        <li class="nav-item" role="presentation">
											...
											<table
												...
												<tbody>
													<tr class="odd">
														...
														<td><div class="text-body">2012-12-12 13:12:15</div></td>
									...
									<tbody>
										<tr>
											<td width="50%">
												...
												<button type="button" class="btn btn-light btn-cancel-order"
													data-ordernum="202312091000000003">판매취소</button>
												...
												<div class="row justify-content-end delivery-update-area">
													...
													<div class="col-auto">
														<select class="form-select delivery-select">
															<option value="2" selected="">발송준비</option>
													...
													<div class="col-auto">
														<button type="button"
															class="btn btn-light btn-delivery-order"
															data-ordernum="202312091000000003" data-orderstate="2">배송변경</button>
													</div>
						...
						<div class="mt-2 border-top pt-2">
							...
							<div class="mt-3 p-3">
								...
								<table class="table board-list order-detail-list">
									<thead class="table-light" style="text-align: center;">
										<tr>
											...
											<th width="110">상세번호</th>
											<th width="100">상품명</th>
											<th width="90">상품가격</th>
											<th width="90">할인가격</th>
											<th width="100">쿠폰사용</th>
											<th width="130">옵션</th>
											<th width="100">수량</th>
								...
								<table class="table table-borderless mb-1">
									<tbody>
										<tr>
											<td width="50%"><strong>취소사유 : memno</strong></td>
											<td class="text-end">
												<div class="row justify-content-end delivery-update-area">
													<div class="col-auto">
														<button type="button"
															class="btn btn-primary btn-delivery-order"
															data-ordernum="202312091000000003" data-orderstate="2">취소접수완료</button>
													</div>
												</div>
											</td>
										</tr>
