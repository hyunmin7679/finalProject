...
$(function(){
	...
	if(cartSize!=="" && cartSize!=="0") {
		$(".cart-chkAll").prop("checked");
		$("form input[name=nums]").prop("checked");
	}
...
function deleteCartItem(detailNum2) {
	...
	location.href = '${pageContext.request.contextPath}/myPage/deleteCart?detailNum2=' + detailNum2;	
}
		...
		<div class="body-main pt-3">
			...
			<form name="cartForm" method="post">
				<div style="padding: 15px 0 5px;">
					<button type="button" class="btn border btn-light cart-deleteCheck" onclick="deleteCartSelect()();">선택삭제</button>
				</div>
